              ...
              <div class="card-body">
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                      ...
                      <td><?= $row['gaji']; ?></td>
                      <th>
                          <a href="edit_employee.php?id_pegawai=<?= $row['id_pegawai']; ?>" class="btn btn-sm btn-warning">Edit</a>
                          <a href="../php/delete.php?id_pegawai=<?= $row['id_pegawai']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
                          </th>
                    </tr>
                    <?php } ?>
