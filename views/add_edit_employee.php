                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="nama_pegawai" name="nama_pegawai"
                                placeholder="Silahkan isi nama" rows="3" required></input>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="posisi" name="posisi"
                                placeholder="Silahkan isi posisi" required />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <input type="number" class="form-control" id="umur" name="umur"
                              placeholder="Silahkan isi umur" min="1" required />
                      </div>
                  </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="alamat" name="alamat"
                                placeholder="Silahkan isi alamat" required />
                        </div>
                    </div>
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <input type="number" class="form-control" id="Gaji" name="Gaji"
                              placeholder="Silahkan isi Gaji" min="0" required />
                      </div>
                  </div>
